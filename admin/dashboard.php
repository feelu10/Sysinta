...
<body>
  ...
  <div class="sidenav" id="sidenav">
    ...
    <h4 style="margin-left:2rem">Admin Dashboard</h4>
      <li><a href="dashboard.php?faculty=home" onclick="setActive(this)"><i class="fas fa-home"></i> Home</a></li>
      <li><a href="dashboard.php?faculty=addcourse" onclick="setActive(this)"><i class="fas fa-plus"></i> Add Logs</a></li>
      <li><a href="dashboard.php?faculty=view" onclick="setActive(this)"><i class="fas fa-book"></i> Registered Logs</a></li>
